          ...
          {result.items.map((item) => <article className={`message-record ${item.status}`} key={item.id}>
            ...
            <div className="message-record-body">
              ...
              <div className="message-dialogue">
                <div className="message-dialogue-side"><span className="message-speaker">用户提问 <em>{TYPES[item.message_type] || item.message_type}消息</em></span><div className="message-bubble question"><Content value={item.question} /></div></div>
                <div className="message-dialogue-side"><span className="message-speaker ai">AI 回答 <em>{TYPES[item.message_type] || item.message_type}消息</em></span><div className="message-bubble answer"><Content value={item.answer} /></div></div>
