...
export const adminApi = {
  ...
  characterTags: {
    overview: (params = {}, options) => adminPost("/admin/character-tags/overview", params, options),
    list: (params, options) => adminPost("/admin/character-tags/list", params, options),
    createClass: (params, options) => adminPost("/admin/character-tags/classes/create", params, options),
    updateClass: (params, options) => adminPost("/admin/character-tags/classes/update", params, options),
    deleteClass: (params, options) => adminPost("/admin/character-tags/classes/delete", params, options),
    create: (params, options) => adminPost("/admin/character-tags/create", params, options),
    update: (params, options) => adminPost("/admin/character-tags/update", params, options),
    remove: (params, options) => adminPost("/admin/character-tags/delete", params, options),
    moveClass: (params, options) => adminPost("/admin/character-tags/batch/class", params, options),
    exportOrganization: (params = {}, options) => adminPost("/admin/character-tags/organize/export", params, options),
    previewOrganization: (params, options) => adminPost("/admin/character-tags/organize/preview", params, options),
    applyOrganization: (params, options) => adminPost("/admin/character-tags/organize/apply", params, options),
  },
  homeRecommendation: {
