...
| 22 | POST | `/admin/users/wallet/flows` | 查询全局用户流水 | [查看](./admin-user.md#adminuserwalletflows) |
| 23 | POST | `/admin/users/coins/grant` | 后台补发金币 | [查看](./admin-user.md#adminusergrantcoins) |
| 24 | POST | `/admin/users/free-quota/reset` | 重置用户今日免费额度 | [查看](./admin-user.md#adminuserresetfreequota) |
| 25 | POST | `/admin/users/status` | 封禁或解除封禁用户 | [查看](./admin-user.md#adminuseraccountstatus) |
| 26 | POST | `/admin/feedback/list` | 查询用户反馈列表 | [查看](./admin-feedback.md#adminfeedbacklist) |
| 27 | POST | `/admin/products/list` | 查询后台商品列表 | [查看](./admin-product.md#adminproductlist) |
| 28 | POST | `/admin/products/create` | 创建后台商品 | [查看](./admin-product.md#adminproductcreate) |
| 29 | POST | `/admin/products/update` | 编辑后台商品 | [查看](./admin-product.md#adminproductupdate) |
| 30 | POST | `/admin/products/status` | 上下架商品 | [查看](./admin-product.md#adminproductstatus) |
| 31 | POST | `/admin/products/delete` | 下架后台商品 | [查看](./admin-product.md#adminproductdelete) |
| 32 | POST | `/admin/analytics/query` | 查询后台统计 | [查看](./admin-analytics.md#adminanalyticsquery) |
| 33 | POST | `/admin/settings/commerce/benefits` | 查询后台会员权益配置 | [查看](./admin-settings.md) |
| 34 | POST | `/admin/settings/commerce/benefits/save` | 保存后台会员权益配置 | [查看](./admin-settings.md) |

| 35 | POST | `/admin/messages/list` | 查询消息及失败原因 | [查看](./admin-messages.md) |
| 36 | POST | `/admin/messages/detail` | 查询消息内容、生成链路和 Token 明细 | [查看](./admin-messages.md#消息详情) |
| 37 | POST | `/admin/orders/list` | 订单列表 | [查看](./admin-billing.md) |
| 38 | POST | `/admin/subscriptions/list` | 订阅统计与明细 | [查看](./admin-billing.md) |
| 39 | POST | `/admin/settings/list` | 查询系统配置列表 | [查看](./admin-settings.md#查询系统配置列表) |
| 40 | POST | `/admin/settings/update` | 更新系统配置 | [查看](./admin-settings.md#更新系统配置) |
